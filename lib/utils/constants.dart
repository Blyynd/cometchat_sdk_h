...
class CometChatReceiptType {
  ...
  static const String deliveredToAll = "deliveredToAll";
  static const String readByAll = "readByAll";
}
...
class ErrorCode {
  ...
  static const errorInvalidTimezone = "ERROR_INVALID_TIMEZONE";
}
...
class ErrorMessage {
  ...
  static const errorInvalidEmptyTimezone = "Timezone cannot be null or empty";
}
