...
class CometChat {
  ...
  static Map<String, CallListener> _callListener = {};
  ...
  static startTyping(
    ...
    try {
      await channel.invokeMethod('startTyping',
  ...
  static void acceptCall(String sessionID,
    ...
    try {
      if (sessionID.isEmpty) {
        ...
        var result =
            await channel.invokeMethod('acceptCall', {"sessionID": sessionID});
        if (onSuccess != null) onSuccess(Call.fromMap(result));
      }
    } on PlatformException catch (p) {
      _errorCallbackHandler(null, p, null, onError);
  ...
  static Future<void> clearActiveCall() async {
    try {
      await channel.invokeMethod('clearActiveCall', null);
    } catch (e) {
      _errorCallbackHandler(null, null, e, null);
    }
  }
  ...
  static Future<bool> isExtensionEnabled(String extensionId,
    ...
    try {
      final result = await channel
          .invokeMethod('isExtensionEnabled', {"extensionId": extensionId});
  ...
  static Future<void> setSource(
    ...
    try {
      ...
      await channel.invokeMethod('setSource', arguments);
    } on PlatformException catch (p) {
      _errorCallbackHandler(null, p, null, null);
    } catch (e) {
      _errorCallbackHandler(null, null, e, null);
  ...
  static Future<void> setDemoMetaInfo(
    ...
    try {
      final arguments = {"demoMetaInfo": jsonObject};
  ...
  static Future<void> setPlatformParams(
    ...
    try {
      ...
      await channel.invokeMethod('setPlatformParams', arguments);
    } on PlatformException catch (p) {
      _errorCallbackHandler(null, p, null, null);
    } catch (e) {
      _errorCallbackHandler(null, null, e, null);
  ...
  static Future<void> getConversationSummary(
    ...
    try {
      if (receiverId.isEmpty) {
        ...
        final result =
            await channel.invokeMethod('getConversationSummary', arguments);
  ...
  static Future<void> askBot(
    ...
    try {
      if (receiverId.isEmpty) {
        ...
        onError(CometChatException(ErrorCode.errorEmptyAskBotQuestion,
            ErrorMessage.errorEmptyBotID, ErrorMessage.errorEmptyBotID));
      } else {
        final arguments = {
          "receiverId": receiverId,
