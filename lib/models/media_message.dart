...
/// specifically related to a media message, such as the caption, attachment,
/// file, and tags.
class MediaMessage extends BaseMessage {
  ...
  /// constructor requires [messageId], [sender], [receiverType], [receiverId],
  /// and [interactions] to be specified. Other properties are optional.
  MediaMessage(
      {this.caption,
      this.attachment,
      this.file,
  ...
  /// Creates a new `MediaMessage` instance from a map.
